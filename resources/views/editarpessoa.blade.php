...
<div class="card border">
    <div class="card-body">
        <form action="/pessoas/{{$pes->id}}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <div class="form-control-range">
                    ...
                    <div id="imendaHTMLtextInteresse"></div>
